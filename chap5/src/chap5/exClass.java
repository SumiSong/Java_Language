...
//		Student st2 = new Student(5, 'F');
//		Student st3 = st;
		// st.gender = 'M'; // st.gender = ''; = null
...
//		int sn = Student.serialNo; // 리소스를 매우 많이 차지함
//		System.out.println("sn : " + sn); //기초 자료형일 경우 자료형이 가지는 기본값을 가져옴 참조자료형은 null, char는 null
//		Student st = new Student();
//		sn +=1;
//		st.setStudentNo(sn);
...
//		//st.serialNo; //static으로 선언한 변수는 인스턴스 변수를 사용할 수 없다
//		sn+=1;
//		st2.setStudentNo(sn);
//		
//		System.out.println("sn : " + sn);
//		System.out.println("st.getSeriallNO : " + st.getStudentNo());
//		System.out.println("st2.getSeriallNO : " + st2.getStudentNo());
//		
//		
//		
//		
...
//		System.out.println(st.getStudentName() + "은" + st.getRider());
//		System.out.println(st2.getStudentName() + "은" + st.getRider());
...
//		System.out.println(bl.getCarName());
//		System.out.println(tl.getCarName());
